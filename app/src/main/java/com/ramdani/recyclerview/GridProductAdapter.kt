...
import java.util.*
class GridProductAdapter internal constructor(private val
    ...
    override fun onBindViewHolder(holder: GridViewHolder,
                                  position: Int) {Glide.with(holder.itemView.context)
